...
[**Report a vulnerability**](https://github.com/hassio-addons/app-mealie/security/advisories/new)
...
- Issues in Mealie itself; please report those directly to the
  [Mealie project](https://github.com/mealie-recipes/mealie/security/policy).
...
This security policy covers the Mealie app in this repository: the app
